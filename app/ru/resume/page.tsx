...
export const metadata: Metadata = {
  title: 'Резюме — Виктор Кондратюк',
};

export default function ResumeRuPage() {
  const { profile, skills, experience, projects, education, languages, about, ui } = contentRu;
            ...
            <div className="r-head-left">
              ...
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: `${profile.role} · <strong>4+ года</strong> · JavaScript, TypeScript, React/Next.js, Vue`,
                }}
              />
            </div>
            ...
            <aside className="r-col-left">
              <section>
                ...
                <ul className="r-contact-list">
                  ...
                  <li>
                    <span className="r-contact-label">Телефон</span>
